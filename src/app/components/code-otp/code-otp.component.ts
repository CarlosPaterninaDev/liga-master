...
export class CodeOtpComponent {
  ...
  @ViewChild(CodeInputComponent, { static: true}) ngOtpInput!:CodeInputComponent;
  ...
  onCodeCompleted(value: string) {
    ...
    if (value !== '1111') {
      ...
      this.notificationService.successNotification('Bienvenido', 'Ingresa el código de verificación.');
